...
public enum ApplicationConfig implements Config {
    ...
    MessageIncidentRetard       ("incident.message.retard", "Retard"),
    MessageIncidentManifestation("incident.message.manifestation", "Manifestation"),
    MessageIncidentGreve        ("incident.message.greve", "Greve"),
    ;
